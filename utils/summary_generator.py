...
def generate_gpt4_summary_streaming(summary, character_choice, trash_talk_level):
    ...
    Keep your summary concise enough (under 800 characters) as to not overwhelm the user with stats but still engaging, funny, thematic, and insightful. Only respond in character and do not reply with anything other than your recap. Begin by introducing \
